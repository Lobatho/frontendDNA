...
import '../App.css';
class WhitOutMutation extends Component {
constructor(){
  super();
  this.state={
    humans: [],
...
componentDidMount (){
  fetch('https://cors-anywhere.herokuapp.com/'+'http://dnatask-env.eba-uhwmba5d.us-east-2.elasticbeanstalk.com/v1/getMutation/false')
...
export default WhitOutMutation;
